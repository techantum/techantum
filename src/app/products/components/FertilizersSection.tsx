...
export default function FertilizersSection() {
  const products = [
  {
    ...
    image: "https://img.rocket.new/generatedImages/rocket_gen_img_17bc3ff46-1765051026926.png",
  ...
  },
  {
    ...
    image: "https://img.rocket.new/generatedImages/rocket_gen_img_148baeaf2-1771674460453.png",
  ...
  return (
    <section id="fertilizers" className="page-section reveal">
